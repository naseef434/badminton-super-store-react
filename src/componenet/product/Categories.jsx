      ...
      <div className="sidebar">
        <div className="product-widget">
          ...
          <ul className="product-categories">
            {category_data.length ? category_data.map((item, idx) => (
              <li><a href="shop.html">{item?.name || "-"} <span>(0)</span></a></li>
        ...
        <div className="product_list_widget">
          ...
          <div className="item-widget">
            <div className="img-left">
              <a href="single.html"><img src="./assets/img/product/101.jpg" alt="product-meta" /></a>
            </div>
          ...
          <div className="item-widget">
            <div className="img-left">
              <a href="single.html"><img src="./assets/img/product/quick-view.png" alt="product-meta" /></a>
            </div>
            <div className="product-meta">
              <a href="single.html"><h4 className="sm-title">Arsenal Home Jersey</h4></a>
              <span>$55.00</span>
