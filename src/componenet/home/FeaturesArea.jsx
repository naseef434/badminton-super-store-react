            ...
            <div className="row g-0">
                <div className="col-xl-4 col-lg-4 col-md-4 col-sm-12">
                    <div className="fetures">
                        ...
                        <div className="fetures__content">
                            <h4 className="feature-title mb-40">Engage Sports <br />Areana</h4>
                ...
                <div className="col-xl-4 col-lg-4 col-md-4 col-sm-12">
                    <div className="fetures">
                        ...
                        <div className="fetures__content">
                            <h4 className="feature-title mb-40">Badminton<br />Super Store</h4>
                            <p className="d-md-none d-lg-block">all products <span className="discount"><a href="#">up to 70%
                                        off</a></span> limited time discount</p>
                        </div>
                    </div>
                ...
                <div className="col-xl-4 col-lg-4 col-md-4 col-sm-12">
                    <div className="fetures">
                        ...
                        <div className="fetures__content">
                            <h4 className="feature-title mb-40">Badminton<br />Academy</h4>
                            <p className="d-md-none d-lg-block">all products <span className="discount"><a href="#">up to 70%
                                        off</a></span> limited time discount</p>
                        </div>
                    </div>
            ...
            <div className="row g-0">
                <div className="col-xl-4 col-lg-4 col-md-4 col-sm-12">
                    <div className="fetures">
                        ...
                        <div className="fetures__content">
                            <h4 className="feature-title mb-40">Events <br /> Planner</h4>
                            <p className="d-md-none d-lg-block">all products <span className="discount"><a href="#">up to 70%
                                        off</a></span> limited time discount</p>
                        </div>
                    </div>
                ...
                <div className="col-xl-4 col-lg-4 col-md-4 col-sm-12">
                    <div className="fetures">
                        ...
                        <div className="fetures__content">
                            <h4 className="feature-title mb-40">Engage<br />Kick</h4>
                            <p className="d-md-none d-lg-block">all products <span className="discount"><a href="#">up to 70%
                                        off</a></span> limited time discount</p>
                        </div>
                    </div>
                ...
                <div className="col-xl-4 col-lg-4 col-md-4 col-sm-12">
                    <div className="fetures">
                        ...
                        <div className="fetures__content">
                            <h4 className="feature-title mb-40">Kawasaki<br />Swimming Store</h4>
                            <p className="d-md-none d-lg-block">all products <span className="discount"><a href="#">up to 70%
                                        off</a></span> limited time discount</p>
                        </div>
                    </div>
