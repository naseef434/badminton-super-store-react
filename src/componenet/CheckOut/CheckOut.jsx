...
function CheckOut() {
  ...
  <div className="container">
    <div className="notification__message">
      <p><i className="fal fa-window-maximize" />Returning customer? Click here to <a href="login.html">login</a></p>
      <p><i className="fal fa-window-maximize" />Have a coupon? Click here to enter your code</p>
    </div>
    <div className="row">
      <div className="col-xl-7 col-lg-7 col-md-12">
        <div className="checkout_form mb-100">
          <form action="#">
            ...
            <div className="checkout__wrap">
              <label>Company name (optional) <span /></label>
            ...
            <div className="checkout__wrap">
              ...
              <input className="mb-20" type="text" name="add1" placeholder="house number and street number" />
              <input type="text" name="add2" placeholder="apartment,suite,unit,etc.(optional)" />
            </div>
            <div className="checkout__wrap">
              <label>Town / City *<span /></label>
              <input type="text" name="town" />
            </div>
            <div className="checkout__wrap">
              <label>County (optional)<span /></label>
            ...
            <div className="checkout__wrap">
              <label>Order notes (optional) <span /></label>
              <textarea name="ordernote" placeholder="Note about your order, e.g special note for delivery" defaultValue={""} />
            </div>
          </form>
        </div>
      </div>
      <div className="col-xl-5 col-lg-5 col-md-12">
        <div className="cart__acount ml-50">
          <h5>Your order</h5>
          <table>
            <tbody><tr className="first-child-2">
                <td>product</td>
